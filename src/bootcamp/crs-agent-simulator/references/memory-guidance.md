...
- Your key file: `curated/simulation-reports.md`

On rebirth, load workspace `index.md` and output `curated/simulation-reports.md`.
...
- **`{crs_output_folder}/{active-project}/curated/simulation-reports.md`** — simulation audit results (YOUR primary output)
