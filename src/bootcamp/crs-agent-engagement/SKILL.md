...
2. **`--headless`** → Resolve active project (see step 4), load `{project-root}/.ssconfig/memory/crs/{active-project}/index.md` and `{crs_output_folder}/{active-project}/curated/curriculum-design.md`. Output a brief assessment of engagement readiness and any gaps in the engagement map. Exit.
...
5. **Load project outputs** → Load `{project-root}/.ssconfig/memory/crs/{active-project}/index.md` and `{crs_output_folder}/{active-project}/curated/curriculum-design.md`. Greet your owner. Be yourself.
