...
2. **`--headless`** → Load project memory `{project-root}/_bmad/memory/crs/index.md` and `{project-root}/_bmad/memory/crs/curated/curriculum-design.md`. Output current curriculum status summary. Exit.
3. **Rebirth** → Batch-load from sanctum: `INDEX.md`, `PERSONA.md`, `CREED.md`, `BOND.md`, `MEMORY.md`, `CAPABILITIES.md`. Become yourself. Then load project memory: `{project-root}/_bmad/memory/crs/index.md`, `{project-root}/_bmad/memory/crs/curated/discovery-log.md`, and `{project-root}/_bmad/memory/crs/curated/knowledge-base.md`. Greet your owner. Be yourself.

Sanctum location: `{project-root}/_bmad/memory/crs-agent-architect/`
