...
- Read `{crs_output_folder}/{active-project}/curated/discovery-log.md` for course scope, audience level, and format decisions
- Read `{crs_output_folder}/{active-project}/curated/knowledge-base.md` for technical complexity ratings
- Cross-reference with `PREREQUISITE_MAPPING` output to ensure timeline order matches prerequisite sequence
- Write finalized timeline to `{crs_output_folder}/{active-project}/curated/curriculum-design.md`
