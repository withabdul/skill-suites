...
- Read `{crs_output_folder}/{active-project}/curated/discovery-log.md` for course scope, audience, and desired outcomes
- Read `{crs_output_folder}/{active-project}/curated/knowledge-base.md` for technical reference and existing examples
...
- Write finalized project design to `{crs_output_folder}/{active-project}/curated/curriculum-design.md`
