...
- Read `{crs_output_folder}/{active-project}/curated/discovery-log.md` for course scope and audience baseline knowledge
- Read `{crs_output_folder}/{active-project}/curated/knowledge-base.md` for technical dependencies and concept relationships
- Cross-reference with `DYNAMIC_TIMELINE` output to ensure prerequisite order matches time allocation
- Write finalized prerequisite map to `{crs_output_folder}/{active-project}/curated/curriculum-design.md`
