...
- Read `{project-root}/_bmad/memory/crs/curated/discovery-log.md` for the tech stack and timeline scope
- Read MEMORY.md for previously tracked trend patterns
- Write trend assessments to `{project-root}/_bmad/memory/crs/curated/knowledge-base.md`
