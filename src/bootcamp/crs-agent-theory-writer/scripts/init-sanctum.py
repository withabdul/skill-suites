...
all capability files and their supporting references into the sanctum, and
...
Example:
    uv run scripts/init-sanctum.py /Users/me/myproject /path/to/crs-agent-theory-writer
"""
...
SKILL_NAME = "crs-agent-theory-writer"
