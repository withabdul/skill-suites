...
- `BOND.md` — who I serve (course creator's writing preferences and style)
...
- `{project-root}/.ssconfig/memory/crs/` — shared course project memory (all agents read/write)
  ...
  - `curated/discovery-log.md` — locked vision parameters, **audience level** (READ THIS FIRST before writing)
  - `curated/knowledge-base.md` — validated research data
  - `curated/curriculum-design.md` — curriculum, timeline, engagement map (READ THIS before writing)
  - `curated/instructor-profile.md` — tone, delivery style preferences
  - `curated/simulation-reports.md` — student simulation results
  - `curated/content-drafts/` — **primary output folder** — all prose drafts go here
