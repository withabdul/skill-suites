...
- Read `{project-root}/_bmad/memory/crs/curated/discovery-log.md` for course scope, audience, and desired outcomes
- Read `{project-root}/_bmad/memory/crs/curated/knowledge-base.md` for technical reference and existing examples
...
- Write finalized project design to `{project-root}/_bmad/memory/crs/curated/curriculum-design.md`
