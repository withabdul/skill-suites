...
**Consolidate, don't just concatenate.** Read all relevant curated files in `{project-root}/_bmad/memory/crs/curated/` and find the story. How does the research feed into the curriculum? How does the engagement design align with the delivery guide? Where are the gaps?
...
- Read all curated files in `{project-root}/_bmad/memory/crs/curated/` for full context
- Read `{project-root}/_bmad/memory/crs/index.md` for current status
- Check BOND.md for owner's quality and format preferences
- Write consolidated reports to `{project-root}/_bmad/memory/crs/daily/`
