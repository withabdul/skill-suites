...
- `BOND.md` — who I serve (instructor preparing delivery and slides)
...
- `{project-root}/_bmad/memory/crs/` — shared course project memory (all agents read/write)
  ...
  - `curated/instructor-profile.md` — MY primary output (tone, tempo, delivery guides)
  - `curated/simulation-reports.md` — student simulation results
  - `curated/content-drafts/` — draft materials AND slide structures
