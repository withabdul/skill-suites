...
- `BOND.md` — who I serve (course creator designing engagement and retention)
...
- `{project-root}/_bmad/memory/crs/` — shared course project memory (all agents read/write)
  ...
  - `curated/curriculum-design.md` — MY primary output (engagement map, trigger placements — co-owned with Architect)
