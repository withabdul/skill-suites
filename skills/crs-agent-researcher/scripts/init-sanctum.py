...
Example:
    uv run scripts/init-sanctum.py /Users/me/myproject /path/to/crs-agent-researcher
...
SKILL_NAME = "crs-agent-researcher"
...
def main():
    ...
    # Create sanctum structure (no project memory init — Manager handles that)
    ...
    print(f"Note: Shared project memory is managed by crs-agent-manager.")
