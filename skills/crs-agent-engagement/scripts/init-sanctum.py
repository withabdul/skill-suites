...
# dependencies = []
# ///
"""First Breath — Deterministic sanctum scaffolding for crs-agent-consultant.
...
Example:
    uv run scripts/init-sanctum.py /Users/me/myproject /path/to/crs-agent-consultant
...
SKILL_NAME = "crs-agent-engagement"
