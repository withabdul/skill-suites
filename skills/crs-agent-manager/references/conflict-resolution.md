...
4. **Document** — Write the resolution to `{project-root}/_bmad/memory/crs/daily/` and update relevant curated files if needed.
5. **Notify** — Inform the user of what was resolved and why.

## Memory Integration

- Read `{project-root}/_bmad/memory/crs/curated/discovery-log.md` as the source of truth
...
- Write resolution decisions to `{project-root}/_bmad/memory/crs/daily/`
