...
`{project-root}/_bmad/memory/crs/` — the shared course memory space. YOUR key files are:
...
- **`{project-root}/_bmad/memory/crs/curated/instructor-profile.md`** — instructor delivery guides (YOUR primary output)
